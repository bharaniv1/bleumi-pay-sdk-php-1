...
**transfer_address** <br>(Optional) | **string** | Payment transfer address (only used in case of Marketplace payments). Use this field to override the token's settlement address specified in the <a href="https://pay.bleumi.com/app/" target="_blank">Bleumi Pay Dashboard</a> for the payment. |  
