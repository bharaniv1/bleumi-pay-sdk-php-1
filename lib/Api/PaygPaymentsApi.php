...
class PaygPaymentsApi
{
    ...
    {
        $this->extendPaymentWithHttpInfo($id);
    }

    /**
     * Operation extendPaymentWithHttpInfo
     *
     * Enable processing for a payment for 7 days from date of invocation
     *
     * @param  string $id Unique ID identifying this record in your system (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function extendPaymentWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->extendPaymentRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function extendPaymentAsync($id)
    {
        return $this->extendPaymentAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation extendPaymentAsyncWithHttpInfo
     *
     * Enable processing for a payment for 7 days from date of invocation
     *
     * @param  string $id Unique ID identifying this record in your system (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function extendPaymentAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->extendPaymentRequest($id);
    ...
    /**
     * Create request for operation 'extendPayment'
     *
     * @param  string $id Unique ID identifying this record in your system (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function extendPaymentRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling extendPayment'
            );
        }

        $resourcePath = '/v1/payment/payg/{id}/extend';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
