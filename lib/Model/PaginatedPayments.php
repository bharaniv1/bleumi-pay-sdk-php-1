...
class PaginatedPayments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaginatedPayments';
...
'next_token' => 'getNextToken'    ];
     ...
     * Sets results
     *
     * @param \Bleumi\Pay\Model\Payment[] $results results
     *
     * @return $this
     */
     ...
     * Sets next_token
     *
     * @param string $next_token Cursor to fetch next page of results, empty if no more reuslts
     *
     * @return $this
     */
